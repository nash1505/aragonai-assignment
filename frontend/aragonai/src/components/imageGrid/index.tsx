    ...
    <div className="w-full mt-10 space-y-6">
      <div className="flex items-center justify-between border-b border-slate-200 pb-3">
        <h2 className="text-lg font-bold text-slate-800 tracking-tight">
          Your Uploads <span className="text-sm font-normal text-slate-500 ml-1">({images.length} photos)</span>
        </h2>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {images.map((image) => {
          ...
          // If completed, use thumbnailUrl or processedUrl.
          // If pending/processing and not HEIC, we can show the originalUrl.
          // Otherwise, no preview can be shown.
            ...
            >
              ...
              {isDeleting && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-white/70 backdrop-blur-[1px]">
                  ...
                  <span className="mt-1 text-[10px] text-red-600 font-bold tracking-wider">DELETING</span>
                </div>
              )}
